...
def procGoodman(path_to_raw_data = './', basepath_to_save_data = './',overwrite = True): 
    ...
    c2 = Table.Column(data=blank_stringcolumn.copy(),name='date',dtype='S10')
    c3 = Table.Column(data=blank_stringcolumn.copy(),name='time',dtype='S28')
    c4 = Table.Column(data=blank_stringcolumn.copy(),name='exptime',dtype='S4')
    c5 = Table.Column(data=blank_stringcolumn.copy(),name='binning',dtype='S3')
    c6 = Table.Column(data=blank_stringcolumn.copy(),name='filter',dtype='S10')
    c7 = Table.Column(data=blank_stringcolumn.copy(),name='grating',dtype='S10')
    c8 = Table.Column(data=blank_stringcolumn.copy(),name='target_RA',dtype='S12')
    c9 = Table.Column(data=blank_stringcolumn.copy(),name='target_Dec',dtype='S13')
    c10 = Table.Column(data=blank_stringcolumn.copy(),name='fullname',dtype='S20')
    c11 = Table.Column(data=blank_stringcolumn.copy(),name='maskname',dtype='S20')
