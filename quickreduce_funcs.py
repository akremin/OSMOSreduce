...
def get_all_filedata(filenum_dict, datadir, template, maskname,cameras=['r' ,'b'], opamps=[1 ,2 ,3 ,4], tags = '',
                     cut_bias_cols = False, convert_adu_to_e = False, **kwargs):
...
def get_all_stitcheddata(filenum_dict, datadir, template, maskname,cameras=['r' ,'b'], opamps=[1 ,2 ,3 ,4], tags = '',
                     cut_bias_cols = False, convert_adu_to_e = False):
    all_data, all_headers = {}, {}
    for imtype,filenums in filenum_dict:
        all_cam_dat = {}
        all_cam_heads = {}
        for camera in cameras:
            all_dat = {}
            ...
            for filnum in filenums:
                filnm = template.format(cam=camera,imtype=imtype,filenum=filnum,maskname=maskname,tags=tags)
...
def get_all_masterdata(filenums, datadir, template, maskname,cameras=['r' ,'b'], opamps=[1 ,2 ,3 ,4], tags = '',
                     imtype=''):
    all_cam_dat = {}
    all_cam_heads = {}
    for camera in cameras:
